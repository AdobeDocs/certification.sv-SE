...
* Identifiera funktionerna i Magento Open Source
* Skilja rätt omfång och när de ska användas
* Uppvisa kunskap om kataloghantering
* Bearbeta prissättningen med Magento Open Source-funktioner
...
* Identifiera de viktigaste funktionerna i Adobe Commerce
* Identifiera tjänsttillägg i Adobe Commerce
* Identifiera värdalternativ för Adobe Commerce
...
* Beskriv filstrukturen Magento
* Beskriv CLI-kommandon för Magento
* Beskriv kronfunktioner
* Beskriv användningen av di.xml för ett scenario
* Skapa styrenheter för ett scenario
* Beskriv modulstruktur
* Beskriv indexfunktioner
* Beskriv lokalisering
...
* Använd ett databasschema för att ändra en databastabell
...
* Beskriv grundläggande ändringar i kassan
* Beskriv grundläggande användning av offertdata
