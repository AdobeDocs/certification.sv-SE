...
## Så här certifierar du dig {#how-to-get-certified-intro}
...
## Studiematerial {#study-materials-intro}
...
## Exempelfrågor {#sample-questions}
...
## Schemalägg och betala för tentamen {#schedule-and-pay}
...
>[!WARNING]
>
>Adobe Digital Experience Certification Program förbereder uppgraderingar. På grund av detta kan de sökande för närvarande inte boka in examensbesök efter den 13 oktober 2024. Schemaläggningen återgår till det normala när uppgraderingarna är klara.

<!--divider-->

## Hantera dina emblem {#manage-your-badges}
...
>
>**Besök den senaste [Adobe-certifieringsportalen](https://certification.adobe.com/certifications/learn-more?tab=learnmore8){target="_blank"} om du vill ha den senaste informationen.**

<!--divider-->

## Frågor {#questions}

**Frågor?** [Kontakta oss](https://certification.adobe.com/support/contactus){target="_blank"}